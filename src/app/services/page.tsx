...
export default function page() {
  return (
    <div className="w-5/6 mx-auto pb-12">
      <h1 className="text-center text-teal-900 mb-12 text-6xl font-semibold">
        Our Services
      </h1>
      {/* clinic section */}
      <div className="">
      ...
      <div className="sm:grid grid-cols-3 gap-5 mt-24">
        <div className="col-span-1  border text-center bg-teal-900 text-white rounded-lg hover:shadow-xl shadow-black py-5">
          <h1 className=" mb-4 text-4xl text-white font-thin">
            SCREENING PROGRAMS
          </h1>
        ...
        <div className="col-span-1  border text-center bg-teal-900 text-white rounded-lg hover:shadow-xl shadow-black py-5">
          ...
          <p className="my-2 w-3/4 mx-auto sm:full">
      ...
      <div className="my-24 relative h-full">
        <div className="p-8 text-white bg-teal-900 md:bg-teal-900/70 backdrop-blur-md rounded-lg flex flex-col md:flex-row justify-between gap-2">
          <div className="w-[55%]">
            <h1 className="text-center text-4xl text-white mb-4 font-thin">
              EYE CARE EQUIPMENTS
            </h1>
          ...
          <div className="pl-6 mt-8 sm:mt-none">
            <h1 className="md:text-center text-4xl text-white mb-4 font-thin">
