...
export default function Gallery() {
  return (
    <section className='mt-24 bg-teal-900 py-28'>
     <div className="flex justify-between  w-11/12 mx-auto">
      <h1 className="text-white font-semibold text-5xl w-1/4 my-auto">View Our Gallery</h1>

      <div className="grid grid-cols-4 gap-2 grid-rows-6 w-3/4 h-96">
        <div className="col-span-1 row-span-3 relative hover:scale-110 hover:z-20 transition-all duration-400 ">
          <div className="absolute top-0 left-0 size-full bg-black/50 hover:bg-transparent z-10 cursor-pointer"></div>
